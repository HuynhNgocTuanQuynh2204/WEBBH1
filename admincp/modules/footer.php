  ...
  <footer class="bg-primary text-center text-lg-start text-white">
    ...
    <div class="container p-4">
      ...
      <div class="row my-4">
        ...
        <div class="rounded-circle bg-white shadow-1-strong d-flex align-items-center justify-content-center mb-4 mx-auto" style="width: 150px; height: 150px; overflow: hidden;">
            <img src="https://img.freepik.com/premium-vector/hacker-internet-computer-security-technology-logo-concept_498048-1059.jpg" height="70" alt="" loading="lazy" style="object-fit: cover; width: 100%; height: 100%; border-radius: 50%;">
        </div>
          <p class="text-center">A place that teaches you how to keep information safe</p>
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
      © 2020 Copyright:
      <a class="text-white" href="https://mdbootstrap.com/">SECURITY</a>
    </div>
    <!-- Copyright -->
  </footer>
